...
def get_today_limit_from_eastmoney(stock_code):
    ...
    从这个网址获取股票数据：http://nuff.eastmoney.com/EM_Finance2015TradeInterface/JS.ashx?id=0006252
    ...
    # 构建url
    url = 'http://nuff.eastmoney.com/EM_Finance2015TradeInterface/JS.ashx?id=%s' % code
    ...
    # 获取结果中的涨跌停价格
    up_limit = data_line[23].strip()
    down_limit = data_line[24].strip()
