...
# ===导入数据
df = pd.read_hdf(r'C:\Users\SpiceeYJ\Desktop\量化投资\网课代码\data\择时策略-回测\signals.h5', key='df')
...
# ===将数据存入hdf文件中
df.to_hdf(r'C:\Users\SpiceeYJ\Desktop\量化投资\网课代码\data\择时策略-回测\pos.h5', key='df', mode='w')
