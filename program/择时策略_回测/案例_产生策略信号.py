...
# =====读入股票数据
stock_code = 'sz000002'
df = pd.read_csv(r'C:\Users\SpiceeYJ\Desktop\量化投资\网课代码\data\择时策略-回测\%s.csv' % stock_code,
...
# =====将数据存入hdf文件中
df.to_hdf(r'C:\Users\SpiceeYJ\Desktop\量化投资\网课代码\data\择时策略-回测\signals.h5', key='df', mode='w')
